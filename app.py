...
# Excess Cape: Used for the second graph
...
def BA():
    ...
    return render_template("Boeing.html", data_indicators_BA=list_indicators_BA, data_CAPE_BA=list_CAPE_BA, data_EXC_BA=list_EXC_BA)
...
def CAT():
    ...
    return render_template("Caterpillar.html", data_indicators_CAT=list_indicators_CAT, data_CAPE_CAT=list_CAPE_CAT, data_EXC_CAT=list_EXC_CAT)
...
def CVX():
    ...
    return render_template("Chevron.html", data_indicators_CVX=list_indicators_CVX, data_CAPE_CVX=list_CAPE_CVX, data_EXC_CVX=list_EXC_CVX)
...
def CSCO():
    ...
    return render_template("Cisco.html", data_indicators_CSCO=list_indicators_CSCO, data_CAPE_CSCO=list_CAPE_CSCO, data_EXC_CSCO=list_EXC_CSCO)
...
def KO():
    ...
    return render_template("Coca-Cola.html", data_indicators_KO=list_indicators_KO, data_CAPE_KO=list_CAPE_KO, data_EXC_KO=list_EXC_KO)
...
def HD():
    ...
    return render_template("Home Depot.html", data_indicators_HD=list_indicators_HD, data_CAPE_HD=list_CAPE_HD, data_EXC_HD=list_EXC_HD)
...
def HON():
    ...
    return render_template("Honeywell.html", data_indicators_HON=list_indicators_HON, data_CAPE_HON=list_CAPE_HON, data_EXC_HON=list_EXC_HON)
...
def INTC():
    ...
    return render_template("Intel.html", data_indicators_INTC=list_indicators_INTC, data_CAPE_INTC=list_CAPE_INTC, data_EXC_INTC=list_EXC_INTC)
...
def JNJ():
    ...
    return render_template("Johnson and Johnson.html", data_indicators_JNJ=list_indicators_JNJ, data_CAPE_JNJ=list_CAPE_JNJ, data_EXC_JNJ=list_EXC_JNJ)
...
def JPM():
    ...
    return render_template("JPMorgan Chase.html", data_indicators_JMP=list_indicators_JPM, data_CAPE_JPM=list_CAPE_JPM, data_EXC_JPM=list_EXC_JPM)
...
def MCD():
    ...
    return render_template("McDonalds.html", data_indicators_MCD=list_indicators_MCD, data_CAPE_MCD=list_CAPE_MCD, data_EXC_MCD=list_EXC_MCD)
...
def MRK():
    ...
    return render_template("Merck.html", data_indicators_MRK=list_indicators_MRK, data_CAPE_MRK=list_CAPE_MRK, data_EXC_MRK=list_EXC_MRK)
...
def PG():
    ...
    return render_template("Procter and Gamble.html", data_indicators_PG=list_indicators_PG, data_CAPE_PG=list_CAPE_PG, data_EXC_PG=list_EXC_PG)
...
def TRV():
    ...
    return render_template("Travelers.html", data_indicators_TRV=list_indicators_TRV, data_CAPE_TRV=list_CAPE_TRV, data_EXC_TRV=list_EXC_TRV)
...
def UNH():
    ...
    return render_template("United Health.html", data_indicators_UNH=list_indicators_UNH, data_CAPE_UNH=list_CAPE_UNH, data_EXC_UNH=list_EXC_UNH)
...
def VZ():
    ...
    return render_template("Verizon.html", data_indicators_VZ=list_indicators_VZ, data_CAPE_VZ=list_CAPE_VZ, data_EXC_VZ=list_EXC_VZ)
...
def WBA():
    ...
    return render_template("Walgreens Boots Alliance.html", data_indicators_WBA=list_indicators_WBA, data_CAPE_WBA=list_CAPE_WBA, data_EXC_WBA=list_EXC_WBA)
...
def WMT():
    ...
    return render_template("Walmart.html", data_indicators_WMT=list_indicators_WMT, data_CAPE_WMT=list_CAPE_WMT, data_EXC_WMT=list_EXC_WMT)
...
def DIS():
    ...
    return render_template("Walt Disney.html", data_indicators_DIS=list_indicators_DIS, data_CAPE_DIS=list_CAPE_DIS, data_EXC_DIS=list_EXC_DIS)
